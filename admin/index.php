...
<html>
  <head>
    ...
    <title>Admin Panel - Elektra Hardware</title>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="index.php?menu=merk"> <i class="icon-presentation"></i><span>Merk / Brand</span></a></li>
            ...
            <li><a href="index.php?menu=kurir"> <i class="icon-user"></i><span>Layanan Jasa</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="../index.php" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><h3>Elektra Hardware</h3></div></a></div>
