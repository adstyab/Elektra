...
<body>
        ...
        <div class="container">
            <?php   
                    if(isset($_SESSION['user_login'])){
                        if ($_SESSION['user_login']['level_user'] == "Admin" || $_SESSION['user_login']['level_user'] == "Seller") {
                        ?>
                        <a class="navbar-brand" href="admin/index.php">Elektra Hardware</a>
                        <?php
                        }
                        else{
                        ?>
    ...
    <div class="container">
        ...
        <div class="row">
          ...
          require('partials/show_merk.php');
