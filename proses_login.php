    ...
    if(isset($_POST['login'])){
        ...
        if(!empty($email) && !empty($password)){
            ...
            if($query_check->num_rows > 0){
                ...
                if(password_verify($password, $password_user)){
                    ...
                    $_SESSION['user_login']['id_konsumen'] = $data_user['id_konsumen'];
                    $_SESSION['user_login']['nama_konsumen'] = $data_user['nama_lengkap'];
        ...
        if(!empty($email) && !empty($password)){
            ...
            if($query_check->num_rows > 0){
                ...
                if(password_verify($password, $password_user)){
                    $_SESSION['user_login']['level_user'] = $level_user;
                    $_SESSION['user_login']['id_konsumen'] = $data_user['id_user'];
                    $_SESSION['user_login']['nama_konsumen'] = $data_user['nama_user'];
