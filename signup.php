...
<html>
  <head>
    ...
    <title>Login Page - Elektra Hardware</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-green fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Elektra Hardware</a>
        ...
        <?php
          ...
          <div class="form-inner">
            ...
            <form id="login-form" method="post" action="proses_signup.php">
              ...
              <div class="form-group">
                <label for="login-adress" class="label-custom">Address</label>
                <input id="login-adress" type="text" name="signup_address" required="">
              </div>
               <div class="form-group">
